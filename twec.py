...
aligner = TWEC(size=30, siter=10, diter=10, workers=4) # 超参数，可调&作图对比
...
slice_one = aligner.train_slice("examples/training/1994.txt", save=True)
slice_two = aligner.train_slice("examples/training/2021.txt", save=True)

# load trained models
model1 = Word2Vec.load("model/1994.model")
model2 = Word2Vec.load("model/2021.model")
